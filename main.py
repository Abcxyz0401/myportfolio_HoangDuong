...
st.set_page_config(page_title='Nguyen Khac Hoang Duong - Portfolio', page_icon="☀", layout="wide")
...
_, col, _ = st.columns((1,3,1))
col.success('''
- I'm interested in AI, Machine Learning, Data Processing, Data Visualization.
- I love nature. I love trees 🌲 , lakes, mountains
- My favorite author is 
[The Present Writter](https://podcasts.google.com/feed/aHR0cHM6Ly9hbmNob3IuZm0vcy8zMjZkNjc2Yy9wb2RjYXN0L3Jzcw) 
(Ms. Chi Nguyen)
''')
...
## Contact Infomation
''')
txt2('Phone', '0975170072')
txt2('Zalo', '0975170072')
txt2('Address', 'Vinh City, Nghe An, Vietnam')
txt2('Email', '[hoangduong4196@gmail.com](mailto:hoangduong4196@gmail.com)')
